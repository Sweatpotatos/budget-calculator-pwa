...
import { getFirestore, collection, addDoc, getDocs, setDoc, doc, enableIndexedDbPersistence, onSnapshot, deleteDoc } from "firebase/firestore";
...
export { db, collection, addDoc, getDocs, setDoc, doc, onSnapshot, deleteDoc };